...
constructor() {
    super();
    // this.tabId = 10;
    this.state = {selectedMonth:'All', selectedYear: 2016, data: [], activeTab:2016, TabId:"mid"};
...
render() {
    return (
      <div>
        <Tabs activeKey={this.state.activeTab} onSelect={this.handleSelect} id={this.state.TabId}>
